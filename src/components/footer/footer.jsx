        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 items-start">
          ...
          <div className="text-white md:text-right">
            ...
            <div className="mt-4 flex md:justify-end items-center gap-5">
              {/* Facebook */}
              <SocialIcon href="https://www.facebook.com/melodieswithmilly" label="Facebook">
              ...
              {/* Instagram */}
              <SocialIcon href="https://www.instagram.com/melodieswithmilly/" label="Instagram">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* TikTok */}
              <SocialIcon href="https://www.tiktok.com/@melodieswithmilly" label="TikTok">
