      ...
      <div className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          <PackageInfoCard
            ...
            price="From £150"
            pastelClass="bg-emerald-100"
            imageSrc={`${basePath}/images/two-entertainer-nicer-princess-party.avif`}
            imageAlt=""
          />
          ...
          <PackageInfoCard
            ...
            imageSrc={`${basePath}/images/two-entertainer-yellow-princess-party.avif`}
            imageAlt=""
          />
          ...
          <PackageInfoCard
            ...
            imageSrc={`${basePath}/images/two-entertainer-bronze-princess-party.avif`}
            imageAlt=""
          />
          ...
          <PackageInfoCard
            ...
            imageSrc={`${basePath}/images/two-entertainer-frozen-princess-party.avif`}
            imageAlt=""
          />
        </div>
      </div>
